...
readonly class user extends Api
{
    ...
    {
        return ["GET" => "[Deprecated] [Пользователь] Получить пользователя", "POST" => '[Deprecated] [Пользователь] Создать пользователя', "PUT" => "[Deprecated] [Пользователь] Обновить пользователя", "DELETE" => '[Пользователь] Удалить пользователя'];
    }
}