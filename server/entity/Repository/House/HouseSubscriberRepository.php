...
/**
 * @method HouseSubscriber|null fetch(?EntityCriteria $criteria = null, ?EntitySetting $setting = null)
 ...
 *
 * @method HouseSubscriber|null findById(int $id, ?EntityCriteria $criteria = null, ?EntitySetting $setting = null)
 *
...
{
    /**
     * @use AuditTrait<HouseSubscriber>
     */
    use AuditTrait;
