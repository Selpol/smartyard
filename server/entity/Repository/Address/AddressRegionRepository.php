...
/**
 * @method AddressRegion fetch(?EntityCriteria $criteria = null, ?EntitySetting $setting = null)
 ...
 *
 * @method AddressRegion|null findById(int $id, ?EntitySetting $setting = null)
 *
