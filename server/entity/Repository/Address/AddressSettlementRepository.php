...
/**
 * @method AddressSettlement|null fetch(?EntityCriteria $criteria = null, ?EntitySetting $setting = null)
 ...
 *
 * @method AddressSettlement|null findById(int $id, ?EntityCriteria $criteria = null, ?EntitySetting $setting = null)
 *
...
{
    /**
     * @use AuditTrait<AddressSettlement>
     */
    use AuditTrait;
    ...
    public function __construct()
    {
        ...
        $this->auditName = 'Адрес-Поселение';
    }
}